 ...
 * Adapts to grid and list views matching CustomCardItem pattern
 */
export function AddCardButton({ onClick, view }: AddCardButtonProps) {
  // Grid view variant
  if (view === 'grid') {
    return (
      <button
        onClick={onClick}
        className="block w-full border-0 p-0 text-left"
  ...
  return (
    <button
      ...
      aria-label="Add custom card"
    >
      <Card className="cursor-pointer gap-0 border border-dashed border-gray-300 bg-transparent py-0 transition-all duration-200 hover:border-blue-500 hover:bg-blue-50/50 dark:border-gray-700 dark:hover:border-blue-500 dark:hover:bg-blue-950/20">
