...
export function AddCardButton({ onClick }: AddCardButtonProps) {
  return (
    ...
    >
      <Card className="h-24 cursor-pointer border-2 border-dashed border-gray-300 bg-transparent py-0 transition-all duration-200 hover:border-blue-500 hover:bg-blue-50/50 dark:border-gray-700 dark:hover:border-blue-500 dark:hover:bg-blue-950/20">
