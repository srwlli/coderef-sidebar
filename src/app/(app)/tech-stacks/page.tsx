          ...
          <div className="space-y-6">
            ...
            >
              <div className="grid gap-4 text-sm md:grid-cols-3">
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                  <h5 className="mb-2 font-semibold">Choose SvelteKit when:</h5>
                  <ul className="space-y-1 text-gray-700">
                ...
                <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                  ...
                  <ol className="space-y-2 text-sm">
                    ...
                    <li className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-green-600">(Compiler)</span>
                    </li>
                    <li className="flex items-center gap-2">
                ...
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  ...
                  <ol className="space-y-2 text-sm">
                    ...
                    <li className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-blue-600">(Emerging)</span>
                    </li>
                  </ol>
                </div>
                ...
                <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                  ...
                  <ol className="space-y-2 text-sm">
                    ...
                    <li className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-purple-600">(Mature)</span>
                    </li>
                    <li className="flex items-center gap-2">
          ...
          <div className="space-y-6">
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
              <p className="text-sm text-blue-800">
                Tier 3 architectures reflect mature, widely adopted technologies
                ideal for teams needing stability, maintainability, and
                ecosystem support. These stacks provide predictable deployments
                with well-established tooling.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  ...
                  <div className="space-y-2 text-sm text-blue-800">
                    ...
                    <p>
                      <strong>Deployment:</strong> Docker, Railway, Heroku, VPS
                    </p>
                  </div>
                </div>
                ...
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  ...
                  <div className="space-y-2 text-sm text-blue-800">
                    ...
                    <p>
                      <strong>Styling:</strong> Vuetify, Tailwind, BootstrapVue
                    </p>
                    <p>
                      <strong>Deployment:</strong> Render, Railway, traditional
                      servers
                    </p>
                  </div>
                </div>
                ...
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  ...
                  <div className="space-y-2 text-sm text-blue-800">
                    <p>
                      <strong>Use Case:</strong> Enterprise-scale internal apps
                    </p>
                    <p>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                  ...
                  <div className="space-y-2 text-sm text-purple-800">
                    ...
                    <p>
                      <strong>Deployment:</strong> Capacitor → App Stores or Web
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                  ...
                  <ul className="space-y-2 text-sm text-green-800">
                    ...
                    <li>
                      • 📦 <strong>Broad Talent Pool</strong> - Easy to hire and
                      scale dev teams
                    </li>
                    <li>
                    ...
                    <li>
                      • 🔁 <strong>Incrementally Upgradeable</strong> - Easy to
                ...
                <div className="rounded-lg border border-orange-200 bg-orange-50 p-4">
                  ...
                  <ul className="space-y-2 text-sm text-orange-800">
                    ...
                    <li>
                      • The <strong>performance profile</strong> doesn't demand
                      edge/SSR
                    </li>
                    <li>
            ...
            >
              <div className="space-y-4">
                ...
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  ...
                  <div className="space-y-2 text-sm text-blue-800">
                    <p>
                      <strong>Use Case:</strong> Admin panels, dashboards, light
                      SPAs
                    </p>
                    <p>
            ...
            >
              <div className="space-y-4">
                ...
                <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                  ...
                  <div className="space-y-2 text-sm text-purple-800">
                    <p>
                      <strong>Use Case:</strong> MVPs, startups, multi-platform
                      UIs
                    </p>
                    <p>
                      <strong>Backend:</strong> Firebase Auth, Firestore, Cloud
                      Functions
                    </p>
                    <p>
                ...
                <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                  ...
                  <div className="space-y-2 text-sm text-purple-800">
                    <p>
                      <strong>Use Case:</strong> Hybrid apps with web+native UI
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>Deployment:</strong> iOS/Android and PWA from one
                      codebase
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                  ...
                  <ul className="space-y-2 text-sm text-green-800">
                    ...
                    <li>
                      • ✅ <strong>Maintainability</strong> - Long-term support
                      and community
                    </li>
                    <li>
        ...
        >
          <div className="space-y-6">
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
              ...
              <p className="text-sm text-blue-800">
                This document defines a production-grade full-stack architecture
                using Next.js App Router, compliant with Lloyd Tier 5
                specifications. It includes core stack choices, deployment
                model, file structure, and up-to-date version references with
                documentation links.
              </p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                ...
                <ul className="list-inside list-disc space-y-1 text-sm text-green-800">
                  ...
                  <li>✅ Modular codebase separation (client/server/shared)</li>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="p-2">2025-09-12</td>
                      <td className="p-2">Added real-time version research</td>
                      <td className="p-2">Lloyd</td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="space-y-6">
            <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
              ...
              <p className="text-sm text-purple-800">
                This document defines a production-grade full-stack architecture
                using Qwik Framework, compliant with Lloyd Tier 5
                specifications. It emphasizes performance, edge-resume
                rendering, modularity, and type safety, with the latest version
                references and docs.
              </p>
            </div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="space-y-1">
                    ...
                    <tr className="border-b">
                      ...
                      <td className="p-2 font-bold">Built-in</td>
                      <td className="p-2 text-xs">Qwik file-based endpoints</td>
                    </tr>
                    <tr className="border-b">
                      <td className="p-2 font-medium">Validation</td>
                      <td className="p-2">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                ...
                <ul className="space-y-1 text-sm text-purple-800">
                  ...
                  <li>
                    <strong>Focus:</strong> Performance, Edge-native rendering,
                    Minimal JS, DX
                  </li>
                  <li>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                ...
                <ul className="space-y-1 text-sm text-purple-800">
                  ...
                  <li>
                    <strong>Focus:</strong> Edge/SSR, Type Safety, Performance,
                    Modular Structure
                  </li>
                  <li>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="p-2 text-xs">
                        SvelteKit supports SSR + static + client side as needed
                      </td>
                    </tr>
                    <tr className="border-b">
                    ...
                    <tr className="border-b">
                      ...
                      <td className="p-2 font-bold text-green-600">✅</td>
                      <td className="p-2 text-xs">Drizzle ORM + Drizzle Kit</td>
                    </tr>
                    <tr className="border-b">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                ...
                <ul className="list-inside list-disc space-y-1 text-sm text-green-800">
                  ...
                  <li>✅ Monorepo-friendly and works with Next.js backends</li>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b">
                      ...
                      <td className="p-2 font-bold text-green-600">✅</td>
                      <td className="p-2 text-xs">Zustand or TanStack Query</td>
                    </tr>
                    <tr className="border-b">
          ...
          <div className="space-y-6">
            <div className="rounded-lg border border-cyan-200 bg-cyan-50 p-4">
              ...
              <p className="text-sm text-cyan-800">
                Defines a high-performance, type-safe architecture for building
                mobile apps using Flutter, Dart Frog, and Supabase — ideal for
                complex mobile UI and edge-compatible APIs.
              </p>
            </div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="space-y-1">
                    ...
                    <tr className="border-b">
                      ...
                      <td className="p-2 font-bold">Built-in</td>
                      <td className="p-2 text-xs">Built-in with Flutter SDK</td>
                    </tr>
                    <tr className="border-b">
                      <td className="p-2 font-medium">E2E Testing</td>
                      <td className="p-2">
                    ...
                    <tr className="border-b">
                      <td className="p-2 font-medium">Deployment</td>
                      <td className="p-2">Play Store / App Store / Firebase</td>
                      <td className="p-2 font-bold">N/A</td>
                      <td className="p-2">
                        <a
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                ...
                <ul className="list-inside list-disc space-y-1 text-sm text-green-800">
                  ...
                  <li>✅ Supabase gives managed Postgres, Auth, and storage</li>
              ...
              <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                ...
                <ul className="space-y-1 text-sm text-purple-800">
                  ...
                  <li>
                    <strong>Focus:</strong> Native UX, Edge-Ready APIs, Modular
                    State, Type-Safety
                  </li>
                  <li>
                    <strong>Verified:</strong> Flutter 3.22.1, Dart 3.4.0, Dart
                    Frog 1.1.1
                  </li>
                </ul>
              </div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b">
                      <td className="p-2">State Management</td>
                      <td className="p-2 font-bold text-green-600">✅</td>
                      <td className="p-2 text-xs">Riverpod modular pattern</td>
                    </tr>
                    <tr className="border-b">
                      <td className="p-2">Testing Support</td>
                      <td className="p-2 font-bold text-green-600">✅</td>
          ...
          <div className="space-y-6">
            <div className="rounded-lg border border-teal-200 bg-teal-50 p-4">
              ...
              <p className="text-sm text-teal-800">
                Defines a hybrid-mobile architecture using SvelteKit for UI and
                backend endpoints, wrapped into native containers using
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                ...
                <ul className="list-inside list-disc space-y-1 text-sm text-green-800">
                  ...
                  <li>✅ Uses SvelteKit for backend & frontend in one repo</li>
                  <li>
              ...
              <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                ...
                <ul className="space-y-1 text-sm text-purple-800">
                  ...
                  <li>
                    <strong>Verified:</strong> All core stack pieces are current
                  </li>
                </ul>
              </div>
            </div>
