...
export default function CoderefApplicationPage() {
  const techStackData = {
    core: [
      {
        name: 'Next.js',
    ...
    <div className="p-8">
      <main className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Link href="/applications/coderef" className="block">
            <Card className="h-24 cursor-pointer transition-shadow duration-200 hover:shadow-lg">
              <CardHeader className="flex h-full flex-row items-center justify-center p-4 text-center">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                that serves as a centralized hub for managing applications,
                tracking quick ideas, accessing development tools, and
                organizing tech stack information. It's designed to streamline
                the developer workflow by providing easy access to commonly used
                resources and application documentation.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="text-muted-foreground space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Application Management:</strong> Organize and track
                    up to 16 different applications with individual landing
                    pages
                  </span>
                </li>
                <li className="flex items-start gap-2">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-lg bg-blue-50 p-3">
                  ...
                  <p className="text-sm text-blue-700">
                    Personal application tracking, idea management, and quick
                ...
                <div className="rounded-lg bg-green-50 p-3">
                  ...
                  <p className="text-sm text-green-700">
                    Collaborative application dashboard for sharing tech stacks,
                    tools, and application documentation.
                  </p>
                </div>
                <div className="rounded-lg bg-purple-50 p-3">
                  ...
                  <p className="text-sm text-purple-700">
                    Track different technology experiments, learning
                    applications, and maintain development notes.
                  </p>
                </div>
                <div className="rounded-lg bg-orange-50 p-3">
                  ...
                  <p className="text-sm text-orange-700">
                    Showcase applications with detailed tech stack information
            ...
            <div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  ...
                  <p className="text-sm text-blue-700">
                    Organize up to 16 applications with individual landing
                    pages, tech stack documentation, and navigation between
                    application details.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-orange-200 bg-orange-50 p-4">
                  ...
                  <p className="text-sm text-orange-700">
                    ...
                    libraries, and tools used across different applications.
                  </p>
                </div>
              </div>
            </div>
