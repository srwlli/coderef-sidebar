...
// Coderef2 application page with mock data
// TODO: Replace with actual application data when application details are defined
export default function Coderef2ApplicationPage() {
    ...
    <div className="p-8">
      <main className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Link href="/applications/coderef2" className="block">
            <Card className="h-24 cursor-pointer transition-shadow duration-200 hover:shadow-lg">
              <CardHeader className="flex h-full flex-row items-center justify-center p-4 text-center">
